...
<p style="text-align: center;"><img src="media/image2.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 517px;" /></p>

使用"手机号注册"，输入手机号码，点击"获取验证码"。输入手机接收到的验证码，勾选同意服务条款，点击"开始体验"按钮。即可进入登录状态。

<p style="text-align: center;"><img src="media/image3.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1080px;" /></p>

点击页面右上角的"控制台"按钮，进入控制后台页面。

<p style="text-align: center;"><img src="media/image4.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 885px;" /></p>

点击左上角的图标，弹出"产品与服务"菜单。

<p style="text-align: center;"><img src="media/image5.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 889px;" /></p>

在产品服务列表中往下翻，找到"人工智能与算法"的板块，点击其中的"火山方舟"条目。

<p style="text-align: center;"><img src="media/image6.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 597px;" /></p>

此时会弹出向新用户赠送tokens的活动提示，点击"立即体验"即可获取。

<p style="text-align: center;"><img src="media/image7.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1080px;" /></p>

进入"火山方舟"页面后，在左侧的项目栏里往下翻。找到"开通服务"的选项，点击进入，此时在右侧面板会显示可以开通的大模型服务。找到具有免费推理额度的模型，这里选择的是"Doubao-pro-32k"模型，点击右侧的"开通服务"一项。

<p style="text-align: center;"><img src="media/image8.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 664px;" /></p>

此时会要求进行身份认证，请根据情况选择认证方式即可。在个人认证中，可以使用抖音APP进行认证。

<p style="text-align: center;"><img src="media/image9.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1629px;" /></p>

认证完成后，会进入服务开通页面。选择要开通服务的大模型，这里选择"Doubao-pro-32k"模型，勾选同意协议的选项，然后点击右下角的"立即开通"按钮。

<p style="text-align: center;"><img src="media/image10.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1130px;" /></p>

在订单列表里确认开通的模型信息，然后点击"提交"按钮即可开通这个大模型的服务。

<p style="text-align: center;"><img src="media/image11.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1375px;" /></p>

要通过网络接口远程调用大模型，还需要创建相应的调用接口。在"火山方舟"页面左侧的服务列表中，翻到最下面。找到"API Key管理"的页面选项，点击进入。在这个管理页面中，点击"创建 API Key"按钮，即可创建远程调用需要的API Key。

<p style="text-align: center;"><img src="media/image12.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1297px;" /></p>
...
<p style="text-align: center;"><img src="media/image13.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1089px;" /></p>

在"在线推理"页面中，点击"创建推理接入点"按钮。

<p style="text-align: center;"><img src="media/image14.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1391px;" /></p>

填写接入点名称，选择模型，确认购买方式，最后点击"确认接入"按钮即可创建接入点。

<p style="text-align: center;"><img src="media/image15.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1280px;" /></p>

之后会看到已经创建的接入点列表，点击右侧的"API调用"查看详细的接口信息。

<p style="text-align: center;"><img src="media/image16.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1073px;" /></p>
...
<p style="text-align: center;"><img src="media/image17.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 570px;" /></p>

在Arduino IDE里点击左上角菜单栏的"文件"，在弹出的菜单列表选择"Save"。

<p style="text-align: center;"><img src="media/image18.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 543px;" /></p>

为这个工程取个名字，比如"llm_doubao"，保存到一个确定的位置。然后将Gitee上下载的配套例程的xfyun_helper.h、xfyun_helper.cpp、doubao.h和doubao.cpp拷贝到.ino文件所在的文件夹里。

<p style="text-align: center;"><img src="media/image19.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 728px;" /></p>
...
<img src="./media/image20.jpg" style="width: 573px;" />
<img src="./media/image21.jpg" style="width: 541px;" />
```c
TFT_eSPI tft = TFT_eSPI(320,480);
U8g2_for_TFT_eSPI u8g2;
```
...
<p style="text-align: center;"><img src="media/image22.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 1078px;" /></p>
...
<p style="text-align: center;"><img src="media/image23.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 614px;" /></p>

回到Arduino IDE，点击工具栏里的设备框左侧的向下箭头，弹出端口列表。从中选择上传程序的端口号，比如下图中的COM10。

<p style="text-align: center;"><img src="media/image24.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 528px;" /></p>

在弹出的窗口中，搜索栏里输入"esp32s3 dev"。在下方的列表中，选择"ESP32S3 Dev Module"一项。然后点击窗口右下角的"确定"按钮。

<p style="text-align: center;"><img src="media/image25.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 751px;" /></p>

5.  启用ESP32的扩展内存PSRAM，以录制较长时长的音频数据。在Arduino IDE中打开"工具"菜单，在"PSRAM"一项中勾选"OPI PSRAM"。

<p style="text-align: center;"><img src="media/image26.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 845px;" /></p>

6.  回到Arduino IDE界面，点击工具栏里的上传按钮，就可以开始编译程序并上传到开发板的ESP32里运行了。

<p style="text-align: center;"><img src="media/image27.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 502px;" /></p>

编译的过程会比较耗时，需要耐心等待。直到界面下方的终端窗口提示如下信息，说明程序上传完毕并已经开始执行。

<p style="text-align: center;"><img src="media/image28.jpg" alt="" style="display: block; margin-left: auto; margin-right: auto; width: 874px;" /></p>
