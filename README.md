...
- [安装 ESP32 Arduino 开发环境](./beginner_tutorials/0/0_ide.md)
- [实验一 GPIO输出实验](./beginner_tutorials/1/1_gpio_output.md)
- [实验二 GPIO输入实验](./beginner_tutorials/2/2_gpio_input.md)
- [实验三 LCD显示屏实验](./beginner_tutorials/3/3_lcd.md)
- [实验四 触摸屏实验](./beginner_tutorials/4/4_touch.md)
- [实验五 摇杆控制实验](./beginner_tutorials/5/5_joystick.md)
- [实验六 电机控制实验](./beginner_tutorials/6/6_motor.md)
- [实验七 舵机控制实验](./beginner_tutorials/7/7_servo.md)
- [实验八 姿态传感器实验](./beginner_tutorials/8/8_imu.md)
- [实验九 音频输出实验](./beginner_tutorials/9/9_speaker.md)
- [实验十 音频输入实验](./beginner_tutorials/10/10_mic.md)
- [实验十一 TF卡存储实验](./beginner_tutorials/11/11_tf_recorder.md)
- [实验十二 TF卡读取实验](./beginner_tutorials/12/12_tf_player.md)
- [实验十三 WiFi通讯实验](./beginner_tutorials/13/13_wifi.md)
- [实验十四 语音识别实验](./beginner_tutorials/14/14_speech_recognizer.md)
- [实验十五 大语言模型实验](./beginner_tutorials/15/15_llm_doubao.md)
- [实验十六 AI语音对话实验](./beginner_tutorials/16/16_chatbot_doubao.md)
